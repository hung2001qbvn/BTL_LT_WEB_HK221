                    ...
                    <div class="form-row clearfix">
                        <div class="form-col fl-left">
                            ...
                            <input style="height: 38px;width: 250px;border: 1px solid #cccccc;" type="password"
                                name="password" id="address" class="form-control">
                        </div>
                    </div>
                    <div class="form-row clearfix">
                        <div class="form-col fl-left">
                            <a href="admin/?modules=users&controller=index&action=login">Đăng nhập với tư cách QTV</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-row clearfix">
                        ...
                        <div class="form-col fl-right">
                            ...
                            <input style="height: 38px;width: 275px;border: 1px solid #cccccc;" type="password"
                                name="password" id="mail" class="form-control">
                        </div>
                    </div>
                    <div class="form-row clearfix">
                        <div class="form-col fl-left">

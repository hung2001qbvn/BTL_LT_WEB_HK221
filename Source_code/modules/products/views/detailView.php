        ...
        <div class="main-content fl-right">
                ...
                <div class="section-detail clearfix">
                    ...
                    <div class="info fl-right">
                        ...
                        <div class="num-product">
                            ...
                            <span class="status"
                                style="background-color: green; color: white; border-radius: 5px;"><?php echo $data['1']['status']; ?></span>
                        </div>
            ...
            <div class="section comment-section" id="same-category-wp">
                ...
                <div class="my-3" id="comment-<?php echo $value['id'] ?>">
                    ...
                    <div class="answer-small-btn" id="rep-btn-<?php echo $value['id'] ?>" onclick="display(this)">Trả
                        lời</div>
                    <form class="w-50 ms-4" id="rep-comment-<?php echo $value['id'] ?>" action="<?php echo $urlll ?>"

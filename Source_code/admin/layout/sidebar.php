    ...
    <ul id="sidebar-menu">
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item">
                    <a href="?modules=comment&controllers=index&action=list" title="" class="nav-link aha">Quản lí bình
                        luận</a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="?modules=storeInfo&controllers=index&action=add" title="" class="nav-link aha">Sửa thông
                        tin
                        liên hệ</a>
                </li>
            </ul>
